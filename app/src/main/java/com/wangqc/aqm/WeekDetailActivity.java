...
public class WeekDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置ToolBar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_weekdetail);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        title = (TextView) findViewById(R.id.title_week);

        swipeRefreshLayout = (SwipeRefreshLayout)findViewById(R.id.swipe_refresh_week);
            ...
            public void onRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (cityJson != null){
                            try {
                                weekJson = cityJson.getJSONObject("week");
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(WeekDetailActivity.this, "无法获取服务器数据", Toast.LENGTH_SHORT).show();
                                    swipeRefreshLayout.setRefreshing(false);
                                }
                            });
                        }
        ...
        mLinearLayout = (LinearLayout)findViewById(R.id.container_weekdetail);
        ...
        try {
            weekJson = new JSONObject(jsonString);
        } catch (JSONException e) {
            return;
        }
